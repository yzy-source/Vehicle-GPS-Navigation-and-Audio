...
public class deviceActivity extends Activity {
	...
	private void init() {		   
        ...
        if (pairedDevices.size() > 0) {
        	...
        	list.add(new SiriListItem("There is no devices paired!", true));
        	mAdapter.notifyDataSetChanged();
    		mListView.setSelection(list.size() - 1);
        }
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
			 	if(mBtAdapter.isDiscovering()) 
			 	{
			 		...
			 		seachButton.setText("Search again");
			 	}
			 	else
			 	{
			 		list.clear();
					...
					seachButton.setText("Stop search");
			 	}				 
			}
		};
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            Bluetooth.BlueToothAddress = address;
             ...
             StopDialog.setTitle("Connect");//标题
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action)) 
            {
                ...
                {
                	list.add(new SiriListItem("Found no bluetooth devices", false));
                	mAdapter.notifyDataSetChanged();
            		mListView.setSelection(list.size() - 1);
                }
                seachButton.setText("Search again");
