...
public class Bluetooth extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("Tab1")
        		.setIndicator("Device List",getResources().getDrawable(android.R.drawable.ic_menu_add))
        		.setContent(new Intent(mContext, deviceActivity.class)));      
        mTabHost.addTab(mTabHost.newTabSpec("Tab2").
        		setIndicator("Dialogue List",getResources().getDrawable(android.R.drawable.ic_menu_add))
